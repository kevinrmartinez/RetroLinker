...
public static class ResourceLoader
{
    ...
    public static string[] GetTextLinesFromResource(Assembly assembly, string resourceName)
    {
        using var stream = assembly.GetManifestResourceStream(resourceName);
        if (stream == null) throw new InvalidDataException($"Resource not found: {resourceName}");
